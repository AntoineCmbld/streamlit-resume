...
st.write('Total bill, sex, day of the week, time of the day, number of people at the table')
...
features = pd.DataFrame([[total_bill, sex, day, time, size]], columns=['total_bill', 'sex', 'day', 'time', 'size'])
